    ...
    <OnboardingShell step={3}>
      ...
      <Form {...form}>
        <form
          ...
          noValidate
        >
          <div className="rounded-[6px] bg-primary/10 px-4 py-2 text-sm font-bold text-primary">
            البيانات الشخصية
          </div>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="50 123 4567" dir="ltr" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="أعد إدخال كلمة المرور" type="password" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
          ...
          <div className="flex items-center justify-between gap-4 rounded-[6px] border border-border p-4">
            <div>
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                تساعد المصادقة الثنائية في حماية حسابك من الوصول غير المصرح به.
              </p>
            </div>
            <Switch

  ...
  React.useEffect(() => {
    ...
    (async () => {
      ...
      try {
        ...
        const res = await api.get<AttendancePage>(
        ...
        {loading
          ...
          : cards.map((c) => {
              ...
              return (
                <div
                  key={c.label}
                  className="rounded-2xl border border-border/80 bg-card p-4 shadow-[0_1px_3px_rgb(0,0,0,0.04)]"
                >
        ...
        <div className="flex flex-col gap-3 border-b border-border/70 px-4 py-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
            <Button
              type="button"
              variant="outline"
              className="h-9 gap-2 rounded-lg border-primary/40 bg-card px-3 font-normal"
            >
            ...
            >
              <SelectTrigger className="h-9! w-full rounded-lg border-border bg-card sm:w-44">
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
                ...
                return (
                  <TableRow key={r.id}>
                    ...
                    <TableCell>
                      <Badge
                        className={cn(
                          "gap-1.5 rounded-full border border-current px-2.5 py-0.5 font-medium",
                          st.className,
                        )}
                      >
                        <span

  ...
  return (
    <div className="space-y-4">
      <div className="grid gap-4 sm:grid-cols-3">
        {kpis.map((c) => {
          ...
          return (
            <div
              key={c.label}
              className="rounded-2xl border border-border/80 bg-card p-5 shadow-[0_1px_3px_rgb(0,0,0,0.04)]"
            >
      ...
      <div className="grid gap-4 lg:grid-cols-5">
        <div className="rounded-2xl border border-border/80 bg-card p-5 shadow-[0_1px_3px_rgb(0,0,0,0.04)] lg:col-span-3">
        ...
        <div className="rounded-2xl border border-border/80 bg-card p-5 shadow-[0_1px_3px_rgb(0,0,0,0.04)] lg:col-span-2">
          <h3 className="text-base font-bold">النشاط الأخير</h3>
          {activity.length === 0 ? (

...
export function TabLeaves({ leaves, loading }: TabLeavesProps) {
  ...
  return (
    <div className="space-y-4">
      <div className="rounded-2xl border border-border/80 bg-card px-5 py-4 shadow-[0_1px_3px_rgb(0,0,0,0.04)]">
              ...
              leaves.map((l) => (
                <TableRow key={l.id}>
                  ...
                  <TableCell>
                    <Badge
                      className={cn(
                        "rounded-full border border-current px-2.5 py-0.5 font-medium",

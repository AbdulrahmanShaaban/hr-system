const DRAFT_KEY = "qawam_onboarding_draft"
const STEP_KEY = "qawam_onboarding_step"
...
const SELECTED_PLAN_KEY = "qawam_onboarding_selected_plan"
const LAST_SUB_KEY = "qawam_onboarding_last_subscription"
